...
namespace Disney.Identity
{
    public static class IdentityServiceExtensions
    {
                                                ...
                                                IConfiguration configuration)
        {
            ...
            services.AddDbContext<DisneyIdentityDbContext>(options =>
                                                            options.UseSqlServer(
                                                            configuration.GetConnectionString("DisneyIdentityConnectionString"),
                                                            b => b.MigrationsAssembly(typeof(DisneyIdentityDbContext).Assembly.FullName)));
